...
<Project Type="Project" LVVersion="21008000">
	...
	<Property Name="NI.Project.Description" Type="Str">The Motion Sensor sample project uses the onboard accelerometer to detect motion and displays the amplitude by using the onboard LEDs of NI myRIO.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			<Item Name="Documentation Images" Type="Folder">
				<Item Name="motion_sensor_block_diagram.gif" Type="Document" URL="../documentation/motion_sensor_block_diagram.gif"/>
			</Item>
			<Item Name="Motion Sensor Documentation.html" Type="Document" URL="../documentation/Motion Sensor Documentation.html"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="#control_StopButton.ctl" Type="VI" URL="../../../../../#Praca/Extensa/UserApp GIT/03_Software/#typedefs/#control_StopButton.ctl"/>
			<Item Name="#TypeDef_Command.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_Command.ctl"/>
			<Item Name="#TypeDef_EnumConnection.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_EnumConnection.ctl"/>
			<Item Name="#TypeDef_ErrorHandler_prop.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_ErrorHandler_prop.ctl"/>
			<Item Name="#TypeDef_FromMRtoPC.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_FromMRtoPC.ctl"/>
			<Item Name="#TypeDef_FromPCtoMR.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_FromPCtoMR.ctl"/>
			<Item Name="#TypeDef_gForm.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_gForm.ctl"/>
			<Item Name="#TypeDef_MomentValues.ctl" Type="VI" URL="../MyRIO/Data Processing/TypeDef/#TypeDef_MomentValues.ctl"/>
			<Item Name="#TypeDef_PropertiesToSave.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_PropertiesToSave.ctl"/>
			<Item Name="#TypeDef_PropGraph.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_PropGraph.ctl"/>
			<Item Name="#TypeDef_SetGet.ctl" Type="VI" URL="../Communication/TypeDef/#TypeDef_SetGet.ctl"/>
			<Item Name="FGV_Stop.vi" Type="VI" URL="../Communication/SubVi/FGV_Stop.vi"/>
			<Item Name="file_name.vi" Type="VI" URL="../../../../#_INŻYNIERSKIE/#Semestry/#Semestr 7/LabVIEW2/Projekt/Oscyloskop_v11/main VI/SubVis/Data Saving/file_name.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="nilvaiu.dll" Type="Document" URL="nilvaiu.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="SignalCalculations.vi" Type="VI" URL="../MyRIO/Data Processing/SubVIs/SignalCalculations.vi"/>
			<Item Name="SpecForm.vi" Type="VI" URL="../MyRIO/Data Processing/SubVIs/SpecForm.vi"/>
			<Item Name="Start_End.ctl" Type="VI" URL="../../../#Semestry/#Semestr 3/Diagnostyka/Lekcje/28_04/Maszyna stanów/Typedefs/Start_End.ctl"/>
			<Item Name="StopLoop.vi" Type="VI" URL="../Communication/SubVi/StopLoop.vi"/>
			<Item Name="WaveformForm.vi" Type="VI" URL="../MyRIO/Data Processing/SubVIs/WaveformForm.vi"/>
		</Item>
...
AddOutputFilter chunkFilter
		...
		<Item Name="MyRIO" Type="Folder" URL="../MyRIO">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
